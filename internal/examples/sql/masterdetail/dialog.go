...
import (
	...
	"github.com/itskovichanton/qt/xml"
)
...
func (d *Dialog) createInputWidgets() *widgets.QGroupBox {
	...
	layout.AddWidget2(artistLabel, 0, 0, 0)
	layout.AddWidget2(d.artistEditor, 0, 1, 0)
	layout.AddWidget2(titleLabel, 1, 0, 0)
	layout.AddWidget2(d.titleEditor, 1, 1, 0)
	layout.AddWidget2(yearLabel, 2, 0, 0)
	layout.AddWidget2(d.yearEditor, 2, 1, 0)
