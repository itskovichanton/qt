...
func GoList(args ...string) *exec.Cmd {
	...
	if UseGOMOD("") {
		if !(strings.Contains(strings.Join(args, "|"), "github.com/itskovichanton/qt/internal") && !strings.Contains(strings.Join(args, "|"), "github.com/itskovichanton/qt/internal/binding/runtime")) {
